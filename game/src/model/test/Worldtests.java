...
public class Worldtests {
	...
	public void testChangeMultiType() throws Exception {
		World w1 = new World(2,2);
		w1.updateTile(tileType.wall, new Point(2,1));
		assertEquals(w1.getTileList().get(2).getTileType(), tileType.wall);	
	}
}
